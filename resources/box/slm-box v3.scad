...
pcbWidth            = 60; // side to side (Y axis)
pcbThickness        = 1.6; 
...
[
  ...
  ["Main",              pcbLength,pcbWidth,    0,0,    pcbThickness,  standoffHeight, standoffDiameter, standoffPinDiameter, standoffHoleSlack],
    ["Sensors",         80,20,    0,pcbWidth+30,    pcbThickness,  53, standoffDiameter, 2.0, standoffHoleSlack]
];
...
//- Add stands 5mm from each corner of the PCB
    [2.5, 2.5, standoffHeight, -1, standoffDiameter, standoffPinDiameter, standoffHoleSlack, 0, 0, yappBaseOnly, yappHole],
    [pcbLength-2.5, pcbWidth-2.5, standoffHeight, -1, standoffDiameter, standoffPinDiameter, standoffHoleSlack, 0, 0, yappBaseOnly, yappHole],
    [2.5, pcbWidth-2.5, standoffHeight, -1, standoffDiameter, standoffPinDiameter, standoffHoleSlack, 0, 0, yappBaseOnly, yappHole],
    [pcbLength-2.5, 2.5, standoffHeight, -1, standoffDiameter, standoffPinDiameter, standoffHoleSlack, 0, 0, yappBaseOnly, yappHole],
    
    [2.0, pcbWidth+30+2.0, 35, -1, standoffDiameter, 1.7, yappBaseOnly, yappHole],
    [pcbLength-2.0, pcbWidth+30+2.0, 35, -1, standoffDiameter, 1.7, yappBaseOnly, yappHole],
    [pcbLength-2.0, pcbWidth+30+20-2.0, 35, -1, standoffDiameter, 1.7, yappBaseOnly, yappHole],
    [2.0, pcbWidth+30+20-2.0, 35, -1, standoffDiameter, 1.7, yappBaseOnly, yappHole]
...
cutoutsBase = 
[
  [40,   90,  50,  50,  0, yappRectangle ,0 ,0, yappCenter, maskHoneycomb],
...
[
//Center test
  [40,   40,  80,  80,  0, yappRectangle ,0 ,0, yappCenter],
  [39,   100,  15,  15,  0, yappRectangle ,0 ,0, yappCenter],
  //[17,   106,  13,  5,  0, yappRectangle ,0 ,0, yappCenter],
  [18,   106,  11,  5,  0, yappRectangle ,0 ,0, yappCenter],
  //[64,   102,  11,  11,  0, yappRectangle ,0 ,0, yappCenter],
  [64.3,   101.3,  10,  10,  0, yappRectangle ,0 ,0, yappCenter],
...
cutoutsLeft =   
[
 [shellLength/2, 23,  5,  5, 4, yappRectangle, yappCenter, yappCoordBox]
];
...
[
   ...
   ,[25, 10, yappBack,  yappSymmetric, yappRectangle, yappCenter]
   ,[30, 10, yappLeft,  yappRight,     yappCenter, yappRectangle,   yappSymmetric]
];
...
boxMounts =
[
 [(shellLength/2), 6, 0, 2.5, yappRight, yappCenter]
];
...
//   p(4) = { yappLeft | yappRight | yappFront | yappBack | yappLid | yappBase yappLid } : plane
//   p(5) = font
//   p(6) = size
//   p(7) = "label text"
//  Optional:
...
labelsPlane =
[
  //  [20, 5, 90, -0.2, yappBase, "Liberation Mono:style=bold", 5, "GPAA 2024" ]
];
...
ridgeExtLeft =
[
[shellLength/2, 5,  25, yappCenter, yappCoordBox]
];
